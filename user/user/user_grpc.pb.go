...
func (c *userClient) LdapSource(ctx context.Context, in *LdapSourceReq, opts ...grpc.CallOption) (*LdapSourceResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LdapSourceResp)
...
func (c *userClient) LdapVerify(ctx context.Context, in *LdapVerifyReq, opts ...grpc.CallOption) (*LdapVerifyResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LdapVerifyResp)
...
type UserServer interface {
	...
	LdapSource(context.Context, *LdapSourceReq) (*LdapSourceResp, error)
	LdapVerify(context.Context, *LdapVerifyReq) (*LdapVerifyResp, error)
...
func (UnimplementedUserServer) LdapSource(context.Context, *LdapSourceReq) (*LdapSourceResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LdapSource not implemented")
}
func (UnimplementedUserServer) LdapVerify(context.Context, *LdapVerifyReq) (*LdapVerifyResp, error) {
