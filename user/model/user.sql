CREATE TABLE `auth_users`  (
    ...
    `role_name` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT "admin" COMMENT '角色名;管理员admin,开发者dev',
    `source` varchar(30) NOT NULL DEFAULT 'local' COMMENT '用户类型1local 2ldap',
    `role_type` tinyint(1) NOT NULL DEFAULT 1 COMMENT '角色类型1管理员admin 2是开发者dev',
    `email` varchar(190) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '用户邮箱',
...
CREATE TABLE `auth_role_menu` (
    `role_name` varchar(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT "admin" COMMENT '角色名;管理员,开发者',
